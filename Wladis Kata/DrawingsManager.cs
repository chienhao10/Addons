...

{
    internal class DrawingsManager
    {
        ...
        {
            var Daggers = ObjectManager.Get<Obj_AI_Minion>().Where(a => a.Name == "HiddenMinion" && a.IsValid && !a.IsDead);
            ...
            foreach (var Dagger in Daggers)
            {
                ...
                if (DrawingsMenu["dDraw"].Cast<CheckBox>().CurrentValue && Daggers != null)
                    Circle.Draw(DColorSlide.GetSharpColor(), 325f, Dagger.Position);
            }
